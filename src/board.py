...
class Board:
    ...
    def __init__(self, screen):
        ...
        self.board_pieces = [[self.rook_black_left, Knight(None, (0, 1), -1, [], black_knight_image, 0, True), Bishop(None, (0, 2), -1, [], black_bishop_image, 0, True), Queen(None, (0, 3), -1, [], black_queen_image, 0, True), King(None, (0, 4), -1, [], black_king_image, 0, True,  self.rook_black_left,  self.rook_black_right), Bishop(None, (0, 5), -1, [], black_bishop_image, 0,True), Knight(None, (0, 6), -1, [], black_knight_image, 0, True),  self.rook_black_right],
                            ...
                            [self.rook_white_left, Knight(None, (7, 1), 1, [], white_knight_image, 0, True), Bishop(None, (7, 2), 1, [], white_bishop_image, 0, True), Queen(None, (7, 3), 1, [], white_queen_image, 0, True), King(None, (7, 4), 1, [], white_king_image, 0, True,  self.rook_white_left,  self.rook_white_right), Bishop(None, (7, 5), 1, [], white_bishop_image, 0, True), Knight(None, (7, 6), 1, [], white_knight_image, 0, True),  self.rook_white_right]]
