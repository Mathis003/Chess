...
if __name__ == '__main__':
    ...
    board = Board(screen)
    piece = Piece(board, None, None, [], [None, None], 0, True)
    pieces = Pieces(board, board.board[7][4], board.board[0][4])
    ...
    game = Game(screen, board, pieces, sound_button, board_color_button)
    game.run()